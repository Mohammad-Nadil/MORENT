      ...
      <div className="bottom flex justify-between items-center">
        <div className="price">
          <p className="text-xl text-primary-text font-bold">
            {price}/<span className="text-sm text-secondary-text">day</span>
          </p>
        </div>
        <div className="btn">
          <Link to="/payment">
            <motion.button whileHover={{scale:1.1}} transition={{type:"spring" , stiffness:300 }} className="font-semibold py-2.5 px-5 text-white bg-primary rounded-md ">
              Rent Now
            </motion.button>
          </Link>
        </div>
