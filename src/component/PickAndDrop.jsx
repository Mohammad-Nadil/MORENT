...
const PickAndDrop = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="switch cursor-pointer h-14 w-14 rounded-xl bg-primary text-white grid place-content-center text-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 shadow-lg shadow-primary/60"
